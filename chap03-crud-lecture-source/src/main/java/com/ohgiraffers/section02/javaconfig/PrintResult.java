...
public class PrintResult {
    ...
    public void printSuccessMessage(String successCode){
        ...
        switch (successCode){
            case "insert" : successMessage = "신규메뉴 등록을 실패했습니다."; break;
            case "update" : successMessage = "메뉴 수정을 실패했습니다."; break;
            case "delete" : successMessage = "메뉴 삭제를 실패했습니다."; break;
        }
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch (errorCode) {
            ...
            case "insert" : errorMessage = "신규메뉴 등록을 실패했습니다."; break;
